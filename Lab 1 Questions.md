...
Hint: the answer is in the comment at the top of the code file. 
...
Finish this program to ask the user questions about their height and swimming ability,
...
Finish the letter mailing price calculating program.
